...
<TwoColumnImageLayout
  leftTopImage={{ src: "https://i.postimg.cc/T3K9SdkY/image.png", alt: "Service radar demo" }}
  leftBottomImage={{ src: "https://i.postimg.cc/tJRJcgNr/image.png", alt: "Pollers" }}
  rightTopImage={{ src: "https://i.postimg.cc/Qd7805r8/image.png", alt: "Onboarding step" }}
  carouselImages={[
    { src: "https://i.postimg.cc/2jJNM6GV/image.png", alt: "Service dashboard" },
    { src: "https://i.postimg.cc/9MhrGbRH/image.png", alt: "Pollers" }
  ]}
/>
